  ...
  DateTimePicker.prototype = {
    ...
    init: function(element, options) {
      ...
      if (this.$element.find('.input-group'))
          this.component = this.$element.find('.input-group-addon.input-group-addon-datetimepicker');
      ...
      if (this.pickDate && this.pickTime) {
        this.widget.on('click.togglePicker', '.accordion-toggle', function(e) {
          ...
          if (expanded && expanded.length) {
            ...
            self.$element.find('.input-group-addon.input-group-addon-datetimepicker i').toggleClass(self.timeIcon + ' ' + self.dateIcon);
          }
        });
      }
      if (this.isInput) {
